...
from geoseg.datasets.qtpl_dataset import *
from geoseg.losses import *
from geoseg.models.WatNet import WatNet
...
# 改
weights_name = "baseline-r50-256-768crop-e100"
weights_path = "model_weights/qtpl/{}".format(weights_name)
test_weights_name = "last"
log_name = 'qtpl/{}'.format(weights_name)
...
train_dataset = QtplDataset(data_root='data/QTPL/Train', mode='train', mosaic_ratio=0.25, transform=get_training_transform())

val_dataset = QtplDataset(data_root='data/QTPL/Val', mode='val', transform=get_validation_transform())
test_dataset = QtplDataset(data_root='data/QTPL/Val', mode='val', transform=get_test_transform())
