...
def parse_args():
    ...
    # 输入图像所在的目录路径
    parser.add_argument("--input-img-dir", default="data/WHDLD/Train/Images")
    # 输入标签所在的目录路径
    parser.add_argument("--input-mask-dir", default="data/WHDLD/Train/Labels")
    # 输出图像所在的目录路径
    parser.add_argument("--output-img-dir", default="data/WHDLD/Train/images_png")
    # 输出标签图像（masks）所在的目录路径
    parser.add_argument("--output-mask-dir", default="data/WHDLD/Train/masks_png")
