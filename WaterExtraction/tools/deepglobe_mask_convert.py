...
CLASSES = ('urban_land', 'agriculture_land', 'rangeland', 'forest_land', 'water', 'barren_land', 'background')

PALETTE = [
    [0, 255, 255],    # urban_land
    [0, 0, 255],      # agriculture_land
    [255, 0, 255],    # rangeland
    [0, 255, 0],      # forest_land
    [255, 255, 0],    # water   红色
...
def parse_args():
    ...
    parser.add_argument("--mask-dir", default="data/DeepGlobe/Train/Labels")
    parser.add_argument("--output-mask-dir", default="data/DeepGlobe/Train/masks_png")
...
def label2rgb(mask):
    ...
    mask_rgb[mask == 1] = PALETTE[4]    # 设置其他的颜色
    return mask_rgb
