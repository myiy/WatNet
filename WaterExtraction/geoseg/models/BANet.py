...
def rest_lite(pretrained=True, weight_path='/Users/yqq/workspace/papers/WaterExtraction/pretrain_weights/rest_lite.pth',  **kwargs):
...
class DependencyPath(nn.Module):
    def __init__(self, weight_path='/Users/yqq/workspace/papers/WaterExtraction/pretrain_weights/rest_lite.pth'):
...
class BANet(nn.Module):
    def __init__(self, num_classes=6, weight_path='/Users/yqq/workspace/papers/WaterExtraction/pretrain_weights/rest_lite.pth'):
